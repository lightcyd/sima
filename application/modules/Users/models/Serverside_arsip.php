...
class Serverside_arsip extends CI_Model
{
  ...
  var $column_order = array('id', 'no_memo', 'divisi',  'nama_pic', 'jenis_kajian', 'sts', 'kajian_resiko', 'tgl_memo', 'tgl_disposisi', 'tgl_input', 'tgl_selesai', 'jarak_hari');
  var $column_search = array('id', 'no_memo', 'divisi', 'nama_pic', 'jenis_kajian', 'sts', 'kajian_resiko',  'tgl_memo', 'tgl_disposisi', 'tgl_input', 'tgl_selesai', 'jarak_hari');
