        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header bg-primary">
              <h5 class="card-title font-weight-bold">TAMBAH DATA KAJIAN</h5>
              ...
              <div class="d-flex flex-row">
                <div class="col-lg-6">
                  <div class="mb-2">
                    ...
                    <button type="submit" name="submit_kajian" class="btn btn-sm btn-success"><i class="fas fa-save"></i> SIMPAN</button>
                  </div>
                </div>
              </div>
              <?php echo form_close() ?>
